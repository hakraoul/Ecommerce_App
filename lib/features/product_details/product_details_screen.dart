...
import 'package:ecommerce_app/features/product_details/services/product_detials_services.dart';
...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  final ProductDetialsServices productDetialsServices =
      ProductDetialsServices();
  double avgRating = 0;
  double myRating = 0;
          ...
          children: [
            ...
            RatingBar.builder(
              ...
              onRatingUpdate: (rating) {
                productDetialsServices.rateProduct(
                  context: context,
